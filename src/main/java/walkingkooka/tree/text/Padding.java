...
public final class Padding extends MarginOrPadding {
    ...
    @Override
    public Padding removeProperty(final TextStylePropertyName<?> propertyName) {
    ...
    @Override
    public Padding clamp(final Length<?> min,
                         final Length<?> max) {
    ...
    @Override
    String prepareText() {
        return this.lengthsToText(BoxEdge::paddingPropertyName);
    }
