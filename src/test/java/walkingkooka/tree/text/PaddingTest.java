...
public final class PaddingTest extends BorderMarginPaddingTestCase<Padding> {
    ...
    public void testClampMaxTop() {
        this.clampAndCheck(
            BoxEdge.TOP.parsePadding("100px"),
            Length.number(1.0),
            Length.number(20.0),
            BoxEdge.TOP.parsePadding("20px")
        );
    }
    ...
    @Test
    public void testTextAllWithLeft() {
        final String text = "left: 1px";
    ...
    public void testTextAllWithRightLeft() {
        this.textAndCheck(
            BoxEdge.ALL.parsePadding("right: 1px; left: 2px;"),
            "right: 1px; left: 2px"
        );
    }
    ...
    @Test
    public void testTextAllWithNothing() {
        final String text = "";
