...
public final class TextStylePropertyNameTest extends TextNodeNameNameTestCase<TextStylePropertyName<?>>
    ...
    @Test
    public void testStylePatchBorder() {
        final TextStylePropertyName<Border> propertyName = TextStylePropertyName.BORDER;
        final Border propertyValue = Border.parse("#123456 SOLID 1px");
        ...
        this.stylePatchAndCheck(
            ...
            JsonNode.object()
                .set(
                    JsonPropertyName.with("border"),
                    "ALL " + propertyValue.text()
                )
        );
    ...
    @Test
    public void testStylePatchBorderBottom() {
        final TextStylePropertyName<Border> propertyName = TextStylePropertyName.BORDER_BOTTOM;
        final Border propertyValue = BoxEdge.TOP.parseBorder("#123456 SOLID 1px");
        ...
        this.stylePatchAndCheck(
            ...
            JsonNode.object()
                .set(
                    JsonPropertyName.with("borderBottom"),
                    "TOP " + propertyValue.text()
                )
        );
    ...
    @Test
    public void testStylePatchBorderColor() {
